...
/*      val library_data = spark.read.option("Header","True").schema(library_schema)
        .csv("D:\\DV\\Courses\\Apache-Spark\\Sources\\intelliji-ws\\SparkCourse-v2\\src\\main\\resources\\Libraries_WiFi_Usage_2011_2014.csv")
        .toDF()
      ;*/
      ...
      val library_data = spark.read.format("csv").option("Header","True").schema(library_schema).
        load("D:\\\\DV\\\\Courses\\\\Apache-Spark\\\\Sources\\\\intelliji-ws\\\\SparkCourse-v2\\\\src\\\\main\\\\resources\\\\Libraries_WiFi_Usage_2011_2014.csv")
      .toDF();
