...
customer_data = spark.read.format("csv").option("Header", "True").schema(customer_schema).load(
    "D:\\\\DV\\\\Courses\\\\Apache-Spark\\\\Sources\\\\intelliji-ws\\\\SparkCourse-v2\\\\src\\\\main\\\\resources\\\\customer_info.csv")


trip_data = spark.read.format("csv").option("Header", "True").option("InferSchema", "true").load(
    "D:\\\\DV\\\\Courses\\\\Apache-Spark\\\\Sources\\\\intelliji-ws\\\\SparkCourse-v2\\\\src\\\\main\\\\resources\\\\yellow_tripdata_2017-02.csv")
